...
BEGIN_MESSAGE_MAP(CTestAppApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CTestAppApp::OnAppAbout)
...
CTestAppApp::CTestAppApp()
{
	...
	SetAppID(_T("TestApp.AppID.NoVersion"));
...
// CTestAppApp customization load/save methods

void CTestAppApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CTestAppApp::LoadCustomState()
{
}

void CTestAppApp::SaveCustomState()
{
}
